...
const form = reactive({
  ...
  email: 'admin@1.com', // Email do usuário admin principal do seeder
  password: 'Mudar@123', // Senha do usuário admin principal do seeder
  password_confirmation: 'Mudar@123', // Confirmação da senha do admin
});
